...
const DietView = (props) => (
  console.log("ID is " + props.issueDiet._id),
  ...
  <tr>
    ...
    <td>
    <Link to={"/updatediet/" + props.issueDiet._id}><Button variant="success">Edit</Button></Link> |{" "}
...
class ViewDietList extends Component {
  ...
  deleteDiet(id) {
    axios.delete("http://localhost:5000/api/warddiet/" + id).then((response) => {

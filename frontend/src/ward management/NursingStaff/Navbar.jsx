...
class NavBar extends Component {
  ...
  <Navbar.Collapse id="basic-navbar-nav">
    ...
    <Nav.Link href="/">Home</Nav.Link>
      <Nav.Link href="/drugadd">Add Drug</Nav.Link>
      <NavDropdown title="More Options" id="basic-nav-dropdown">
        <NavDropdown.Item href="/druglist">View Drugs</NavDropdown.Item>
        <NavDropdown.Item href="/viewdrugissue">View Drug Issue Log</NavDropdown.Item>
        <NavDropdown.Divider />
      </NavDropdown>
    </Nav>
    <Form inline>
